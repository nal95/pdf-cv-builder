                ...
                <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
                    <div class="primary-info">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a href="mailto:${user.email}"><i class="far fa-envelope fa-fw mr-2"
                                                                               data-fa-transform="grow-3"></i>${user.email}
                                </a></li>
                            <li><a><i class="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i>${user.mobile}
                                </a></li>
                        </ul>
                    </div>
                    <div class="secondary-info ml-md-auto mt-2">
                        <ul class="resume-social list-unstyled">
                            <#list resume.networks as network>
                                <li class="mb-3"><a href="${network.link}"><span
                                                class="fa-container text-center mr-2">${network.referenceName}</span>${network.option!""}
                                    </a></li>
                            </#list>
                        </ul>
                    </div>
                    ...
                    <div class="resume-timeline-item mb-4">
                        <div class="resume-timeline-item-header">
                            <div class="resume-timeline-item-desc">
                                <h3 class="resume-timeline-item-title text-dark font-weight-bold">${education.degree}
                                    in ${education.field}</h3>
